...
<%
    ...
    if (iterateExpression.startsWith(JSON_EVAL_START_STRING)) {
        foreachMediator.setExpression(jsonPathFactory.createSynapseJsonPath(ITR_EXPRESSION_KEY, iterateExpression.trim()
                .substring(JSON_EVAL_START_STRING.length(), iterateExpression.length() - 1)));
    } else {
